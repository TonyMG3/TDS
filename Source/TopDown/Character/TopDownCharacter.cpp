...
void ATopDownCharacter::SetupPlayerInputComponent(UInputComponent* InputComponents)
{
	Super::SetupPlayerInputComponent(InputComponents);
	InputComponents->BindAxis(TEXT("MoveForward"), this, &ATopDownCharacter::InputAxisX);
	InputComponents->BindAxis(TEXT("MoveRight"), this, &ATopDownCharacter::InputAxisY);
}
...
void ATopDownCharacter::CharacterUpdate()
{
	...
	void ATopDownCharacter::ChageMovementState()
	{
